      ...
      <>
        <VerticalTimeline lineColor={'black'}>
          ...
          >
            ...
            <ul>
              <li>
                Co-created Enterprise level User Interface for IBM id
              </li>
              <li>
                Created user interface application for internal helpdesk team to manage database
              </li>
            </ul>
          </VerticalTimelineElement>
          <VerticalTimelineElement
              ...
              contentArrowStyle={{background: 'rgb(33, 150, 243)', color: '#fff'}}
              date="2010 - 2011"
              iconStyle={{ background: 'rgb(33, 150, 243)', color: '#fff' }}
              icon={<Enterprise />}
          >
